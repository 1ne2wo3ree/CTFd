...
class ChallengeList(Resource):
    ...
    def get(self, query_args):
        ...
        from CTFd.models import Modules
        module_mapping = {m.id: m.name for m in Modules.query.all()}
            ...
            response.append(
                {
                    ...
                    "module_name": module_mapping.get(challenge.module_id),
                    "tags": challenge.tags,
...
class Challenge(Resource):
    ...
    def get(self, challenge_id):
        ...
        response["module_name"] = chal.module.name if chal.module else None
